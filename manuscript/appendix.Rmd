...
elig_dates <-
tribble(
    ~grouped_date, ~date, ~age_range, ~jcvi_groups,
    "2020-12-08", "2020-12-08", "-", "01, 02, 03",
    "2021-01-18", "2021-01-18", "-", "04",
    ###
    "2021-02-15", "2021-02-15", "-", "05, 06",
    ###
    "2021-02-22", "2021-02-22", "64", "07", 
    "2021-03-01", "2021-03-01", "60-63", "07",
    ###
    # combine 2 rows as < 7 days between elig_dates
    "2021-03-08", "2021-03-08", "56-59", "08",
    "2021-03-08", "2021-03-09", "55", "08",
    ###
    "2021-03-19", "2021-03-19", "50-54", "09",
    ###
    "2021-04-13", "2021-04-13", "45-49", "10",
    # combine 3 rows as < 7 days between elig_dates
    "2021-04-26", "2021-04-26", "44", "10",
    "2021-04-26", "2021-04-27", "42-43", "10",
    "2021-04-26", "2021-04-30", "40-41", "10",
    ###
    # combine 2 rows as < 7 days between elig_dates
    "2021-05-13", "2021-05-13", "38-39", "11",
    "2021-05-13", "2021-05-19", "36-37", "11",
    # combine 3 rows as < 7 days between elig_dates
    "2021-05-21", "2021-05-21", "34-35", "11",
    "2021-05-21", "2021-05-25", "32-33", "11",
    "2021-05-21", "2021-05-26", "30-31", "11",
    ###
    "2021-06-08", "2021-06-08",  "25-29", "12",
    # combine 3 rows as < 7 days between elig_dates
    "2021-06-15", "2021-06-15", "23-24", "12",
    "2021-06-15", "2021-06-16", "21-22", "12",
    "2021-06-15", "2021-06-18", "18-20", "12",
) %>%
  mutate(reference  = "add url")
...
elig_dates %>%
  select(grouped_date, date, jcvi_groups, age_range, reference) %>%
  kable(
      format = "latex",
...
```{r eligibilty-criteria, include=TRUE, fig.cap="Study eiligibility criteria.", out.width="\\linewidth"}
