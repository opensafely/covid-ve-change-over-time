...
metareg_results_k <- readr::read_rds(
  ...
  select(subgroup, sex, ageband, comparison, outcome, k, rhr = logrhr, rhr_lower = logrhr_lower, rhr_higher = logrhr_higher)
```
...
table_metareg_ft <- function(s, a=FALSE) {
...
\tabref{tab:table-ratio-hrs-ft-female} and \ref{tab:table-ratio-hrs-ft-male} give the per-comparison-period ratio of adjusted hazard ratios for females and males respectively.
...
# TODO - remove landscape commands
