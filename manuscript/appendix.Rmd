...
release_folder_new <- here::here("release_20220401")
```
...
estimates_all <- readr::read_csv(
  here::here(release_folder_new, "estimates_all.csv")) %>%
...
metareg_results_k <- readr::read_rds(
  here::here(release_folder_new, "metareg_results_k.rds")) %>%
...
knitr::include_graphics(file.path(release_folder_new, "hr_vax_BNT162b2.png"))
```
...
knitr::include_graphics(file.path(release_folder_new, "hr_vax_ChAdOx1.png"))
```

```{r hr-vax-both, include=TRUE, fig.cap="Unadjusted and adjusted hazard ratios for BNT162b2 vs ChAdOx1", out.width="\\linewidth"}
knitr::include_graphics(file.path(release_folder_new, "hr_vax_both.png"))
```
...
knitr::include_graphics(file.path(release_folder_new, "hr_vax_anytest_BNT162b2.png"))
```
...
knitr::include_graphics(file.path(release_folder_new, "hr_vax_anytest_ChAdOx1.png"))
```
...
knitr::include_graphics(file.path(release_folder_new, "hr_vax_anytest_both.png"))
```
...
knitr::include_graphics(file.path(release_folder_new, "hr_vax_anytest.png"))
```
...
knitr::include_graphics(file.path(release_folder_new, "hr_brand_anytest.png"))
```
